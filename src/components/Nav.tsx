...
export default function Nav () {
    ...
    return (
        <nav className="h-[100vh] bg-primary grid align-between lg:w-1/5 md:w-1/4 sm:w-1/3">
            {/* User information */}
            ...
            <ul className="grid gap-5 p-4">
                <li className="text-white items-center font-semibold text-lg flex gap-2">
                ...
                <li className="text-white flex justify-between items-center">
                    ...
                    {/* Message Count */}
                    <p className="p-4 w-[5px] h-[5px] text-white bg-danger rounded-full flex justify-center items-center font-bold">
                        4
                    </p>
                </li>
                <li className="text-white items-center font-semibold text-lg flex gap-2">
            ...
            <li className="text-white p-4 items-center font-semibold text-lg flex gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
